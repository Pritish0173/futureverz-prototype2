...
import InstitutionSubDomain from './InstitutionSubDomain/InstitutionSubDomain';
...
function InstitutionDomain() {
  ...
  if(value !== null){
    return(
      <div>
        <InstitutionSubDomain domain={value}/>
      </div>
    );
  }
  else{
...
export default InstitutionDomain;