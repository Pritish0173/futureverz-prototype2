    ...
    <div className="tabs">
      <Box sx={{bgcolor: 'transparent' }}>
        <Tabs
          ...
          style={{color: 'purple'}}
        >
          <Tab label="Countries" {...a11yProps(0)} style={{color: 'slateblue', fontWeight: 'bold'}}/>
          <Tab label="Performance" {...a11yProps(1)} style={{color: 'slateblue', fontWeight: 'bold'}} />
          <Tab label="Investment" {...a11yProps(2)} style={{color: 'slateblue', fontWeight: 'bold'}}/>
